...
export class CreateAddressDTO {
	...
	address_1: string;
    @ApiProperty({ description: 'Direccion2, Opcional', example: 'Casa 400' })
	address_2: string;
    ...
    toString(): string {
        return `UserAddress [id_username=${this.id_username}, country_code=${this.country_code}, zipcode=${this.zipcode}, address_1=${this.address_1}, address_2=${this.address_2}, receptor_name=${this.receptor_name}, phone_number=${this.phone_number}]`;
    }
}